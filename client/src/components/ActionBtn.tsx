...
export default function ActionBtn({
  ...
  const baseStyles =
    "inline-flex items-center justify-center font-medium rounded-lg text-sm transition-all duration-200 ease-out cursor-pointer shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2";
